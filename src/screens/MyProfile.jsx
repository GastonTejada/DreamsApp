...
// import AddButton from "../components/AddButton";
// import InputForm from "../components/InputForm";
// import DatePickerInput from "../components/DatePickerInput"; // Importa el nuevo componente
// import SubmitButton from "../components/SubmitButton";
// import { useDispatch, useSelector } from "react-redux";
// import { colors } from "../constants/colors";
// import { useGetActivitiesQuery } from "../services/shopService";
...
//         <InputForm label={"Dirección"} onChange={setDireccion} />
//         <InputForm label={"Teléfono"} onChange={setTelefono} />
//         <DatePickerInput label={"Fecha Nac."} onChange={setFechaNac} />
//         <Text style={styles.label}>Selecciona una Actividad:</Text>
//         <Picker
//           selectedValue={actividadSeleccionada}
//           onValueChange={(itemValue) => setActividadSeleccionada(itemValue)}
...
const MyProfile = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.form}>
        <Text style={styles.title}>Datos del Usuario</Text>
        <InputForm label={"Dirección"} onChange={setDireccion} value={direccion} />
        <InputForm label={"Teléfono"} onChange={setTelefono} value={telefono} />
        <DatePickerInput
          label={"Fecha Nac."}
          onChange={setFechaNac}
          value={fechaNac} // Pasa el valor de fechaNac al componente
        />
        <Text style={styles.label}>Selecciona una Actividad:</Text>
        <Picker
          selectedValue={actividadSeleccionada}
